...
const id: Record<CopyKey, string> = {
  ...
  team_lede: "Menentukan visi. Membangun platform. Menyalurkan onderdil. Setiap tugas ada pemiliknya.",
  ...
  contact_next_3: "Kalau cocok, langkah berikutnya adalah panggilan telepon — mengikuti zona waktu Anda, bukan kami.",
  ...
  privacy_b2_p:
    "Saat Anda bergabung ke waitlist Early Adopters, kami menyimpan detail usaha yang Anda berikan agar bisa menghubungi Anda soal program ini. Data itu tidak dipakai untuk hal lain.",
  privacy_b3_h: "Permintaan deck",
  privacy_b3_p:
    "Saat Anda meminta deck investor, nama, firma, dan email kerja Anda dikirim ke tim lewat email dan dipakai untuk tindak lanjut secara pribadi.",
