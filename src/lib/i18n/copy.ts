...
const en = {
  ...
  how_h2: "Three steps. Zero guessing.",
  how_s1_t: "Select your vehicle",
  how_s1_d: "Year · make · model — down to trim and engine.",
  ymm_y: "Year",
  ymm_mk: "Make",
  ymm_md: "Model",
  ymm_tr: "Trim",
  ...
  cat_pill: "✓ One catalog · 120M+ mappings",
...
const id: Record<CopyKey, string> = {
  ...
  how_h2: "Tiga langkah. Tanpa menebak.",
  how_s1_t: "Pilih mobil Anda",
  how_s1_d: "Tahun · merek · model — sampai ke tipe dan mesinnya.",
  ymm_y: "Tahun",
  ymm_mk: "Merek",
  ymm_md: "Model",
  ymm_tr: "Tipe",
  ...
  cat_pill: "✓ Satu katalog · 120 juta+ data kecocokan",
